...
// Primary color
// Primary por esquema
export const primaryLight = createPaletteChannel(themeConfig.palette.light.primary);
export const primaryDark = createPaletteChannel(themeConfig.palette.dark.primary);
...
export const background = {
  light: createPaletteChannel({
    paper: themeConfig.palette.light.background.paper,
    default: themeConfig.palette.light.background.default,
    neutral: grey[200],
  }),
  dark: createPaletteChannel({
    paper: themeConfig.palette.dark.background.paper,
    default: themeConfig.palette.dark.background.default,
    neutral: grey[700],
  }),
};
...
export const palette: Partial<Record<ThemeColorScheme, ColorSystemOptions['palette']>> = {
  ...
  dark: {
    ...
    action: action.dark,
    divider: varAlpha(grey['500Channel'], 0.3),
  }
};
